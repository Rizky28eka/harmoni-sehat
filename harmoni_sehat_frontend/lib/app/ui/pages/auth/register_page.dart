...
class RegisterPage extends GetView<AuthController> {
  ...
  Widget _buildFormForRole(String role) {
    return Column(
      ...
      children: [
        ...
        _buildTextField(controller.passwordController, 'Password', isObscure: true),
        _buildTextField(controller.confirmPasswordController, 'Confirm Password', isObscure: true),
        if (role == 'Dokter') ...[
          _buildTextField(controller.strController, 'STR Number'),
          _buildTextField(controller.specializationController, 'Specialization'),
        ],
        if (role == 'Apoteker') ...[
  ...
  Widget _buildSocialButtons() {
    return Row(
      mainAxisAlignment: MainAxisAlignment.center,
      children: [
        _buildSocialButton(FontAwesomeIcons.google, () => controller.signInWithGoogle()),
